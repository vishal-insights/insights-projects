...
const services = [
  {
    ...
    desc: 'Ensuring all company and client investments comply with SEBI, RBI, and Companies Act regulations.',
  },
  {
    icon: 'bi-shield-check',
    title: 'Risk Assessment & Mitigation',
    desc: 'Identifying potential investment risks and providing strategies to minimize financial and regulatory exposure.',
  },
  {
    icon: 'bi-file-earmark-text',
    title: 'Investment Documentation',
    desc: 'Preparing, reviewing, and maintaining all necessary investment agreements, contracts, and compliance records.',
  },
  {
    icon: 'bi-bar-chart-line',
    title: 'Portfolio Monitoring & Reporting',
    desc: 'Tracking investment performance, generating reports, and ensuring adherence to compliance standards.',
  },
  {
    icon: 'bi-journal-check',
    title: 'Internal Policy Development',
    desc: 'Creating internal investment policies, procedures, and control frameworks to maintain compliance across operations.',
  },
  {
    icon: 'bi-lightning-charge',
    title: 'Audit & Reconciliation Support',
    desc: 'Assisting in investment audits, reconciling accounts, and verifying regulatory compliance.',
  },
  {
    icon: 'bi-people',
    title: 'Training & Awareness Programs',
    desc: 'Conducting workshops and sessions for staff on investment compliance and regulatory updates.',
  },
  {
    icon: 'bi-globe',
    title: 'Cross-Border Investment Advisory',
    desc: 'Providing guidance on foreign investments, FEMA compliance, and global regulatory requirements.',
  },
  {
    icon: 'bi-graph-up',
    title: 'Strategic Investment Planning',
    desc: 'Advising businesses on compliant investment strategies to optimize returns while minimizing regulatory risks.',
  },
];
