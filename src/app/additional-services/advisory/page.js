...
const services = [
  {
    ...
    desc: 'Guiding entrepreneurs in forming Private Limited, LLP, or OPC companies with full legal compliance.',
  },
  {
    icon: 'bi-file-text',
    title: 'Statutory Filings',
    desc: 'Handling all mandatory ROC filings including annual returns, financial statements, and other regulatory requirements.',
  },
  {
    icon: 'bi-people-fill',
    title: 'Board & Shareholder Meetings',
    desc: 'Planning and managing board and shareholder meetings, preparing notices, agendas, and drafting minutes.',
  },
  {
    icon: 'bi-file-earmark-plus',
    title: 'Resolutions & Documentation',
    desc: 'Drafting board resolutions, shareholder resolutions, agreements, and other corporate documents as per law.',
  },
  {
    icon: 'bi-shield-check',
    title: 'Corporate Governance Advisory',
    desc: 'Advising on best practices for compliance, internal controls, and governance frameworks for companies.',
  },
  {
    icon: 'bi-diagram-3',
    title: 'Mergers & Restructuring',
    desc: 'Providing guidance on mergers, acquisitions, restructuring, and corporate reorganizations.',
  },
  {
    icon: 'bi-clock-history',
    title: 'Compliance Calendar Management',
    desc: 'Creating and maintaining a compliance calendar to ensure timely submissions and avoid penalties.',
  },
  {
    icon: 'bi-book',
    title: 'Policy & Legal Advisory',
    desc: 'Assisting in drafting company policies, codes of conduct, and ensuring legal obligations are met.',
  },
  {
    icon: 'bi-graph-up',
    title: 'Business Advisory & Strategic Support',
    desc: 'Providing expert advice on business growth, financial planning, risk management, and strategic decision-making.',
  },
];
