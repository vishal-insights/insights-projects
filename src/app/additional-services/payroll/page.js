...
const services = [
  {
    ...
    desc: 'Designing employee salary structures including basic pay, HRA, allowances, bonuses, and incentives.',
  },
  {
    icon: 'bi-cash-stack',
    title: 'Payroll Processing',
    desc: 'Calculating monthly salaries, deductions (TDS, PF, ESI), and generating net pay and salary slips.',
  },
  {
    icon: 'bi-file-earmark-check',
    title: 'Statutory Compliance',
    desc: 'Ensuring compliance with labour laws, PF, ESI, professional tax, TDS, and other statutory requirements.',
  },
  {
    icon: 'bi-people',
    title: 'Record Keeping & Reporting',
    desc: 'Maintaining payroll records, attendance, leave, and generating reports for audits and management review.',
  },
  {
    icon: 'bi-bar-chart-line',
    title: 'Payroll Audit & Reconciliation',
    desc: 'Reconciling payroll with bank statements, verifying deductions, and preparing for internal or statutory audits.',
  },
  {
    icon: 'bi-lightning-charge',
    title: 'Tax Planning & Advisory',
    desc: 'Providing guidance on income tax optimization, TDS planning, and other payroll-related financial advice.',
  },
  {
    icon: 'bi-journal-check',
    title: 'Leave & Attendance Management',
    desc: 'Managing employee leave, overtime, and attendance data to ensure accurate salary computation.',
  },
  {
    icon: 'bi-bank',
    title: 'Employee Benefits Administration',
    desc: 'Managing PF, ESI, gratuity, bonuses, reimbursements, and other employee benefit schemes.',
  },
  {
    icon: 'bi-clipboard-check',
    title: 'Payroll Policy Development',
    desc: 'Creating and updating company payroll policies, guidelines, and procedures in line with legal requirements.',
  },
];
