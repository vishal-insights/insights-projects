      ...
      <nav className="fixed top-0 w-full z-50 backdrop-blur-xl bg-white/70 dark:bg-black/70 border-b border-slate-200 dark:border-blue-900">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 h-16 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 flex-1 min-w-0">
            <i className="bi bi-file-text text-blue-500 text-sm sm:text-base shrink-0"></i>
            <span className="
              block
      ...
      <section className="min-h-screen flex items-center justify-center pt-20 px-4 sm:px-6
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-4 text-sm sm:text-base text-slate-600 dark:text-blue-400">
            Company Law • Legal Notices • Service Agreements
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-14">
            ...
            <p className="mt-3 text-slate-600 dark:text-blue-400">
              End-to-End Secretarial & Compliance Support
            </p>
          </div>
...
const services = [
  {
    ...
    desc: 'Drafting Memorandum and Articles as per Companies Act.',
  },
  {
    icon: 'bi-file-earmark-plus',
    title: 'Board Resolutions',
    desc: 'Preparation of resolutions and meeting documentation.',
  },
  {
    icon: 'bi-building',
    title: 'Company Incorporation',
    desc: 'End-to-end incorporation support.',
  },
  {
    icon: 'bi-file-earmark-check',
    title: 'ROC Filings',
    desc: 'Annual returns and statutory filings.',
  },
  {
    icon: 'bi-people',
    title: 'Agreements',
    desc: 'Drafting shareholder & corporate agreements.',
  },
  {
    icon: 'bi-lightning-charge',
    title: 'Legal Notices',
    desc: 'Drafting notices and legal communication.',
  },
]