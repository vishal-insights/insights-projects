      ...
      <div className="relative min-h-screen flex flex-col pb-28 font-[Inter] transition-colors duration-500 bg-gradient-to-b from-white to-white dark:from-black dark:to-black text-black dark:text-white">
        ...
        <header className="py-8 border-b border-black/10 dark:border-white/10 text-center relative z-10">
          ...
          <p className="text-black/40 dark:text-white/40 text-[11px] sm:text-sm mt-1 tracking-wide">
            IBC & NCLAT Preparedness Advisory
          </p>
        </header>
        ...
        <main className="flex-grow px-4 sm:px-12 lg:px-24 py-14 relative z-10">
          ...
          <section className="max-w-3xl mx-auto text-center lg:text-left">
            <h2 className="font-[Playfair_Display] text-[26px] sm:text-4xl md:text-5xl leading-snug bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
             NCLAT Appeals & Regulatory Litigation
            </h2>

            <p className="mt-4 text-black/65 dark:text-white/65 text-sm sm:text-base leading-relaxed">
             Independent NCLAT appeals advisory supporting appellate strategy, regulatory interpretation, and statutory decision-making.
            </p>
            ...
            <div className="mt-6 flex flex-wrap justify-center lg:justify-start gap-x-4 gap-y-2 text-[12px] sm:text-sm text-black/50 dark:text-white/50">
              <span>NCLAT Appeals Advisory</span>
              <span>Appellate Strategy & Advisory</span>
              <span>Statutory & Regulatory Matters</span>
            </div>
          </section>
          ...
          <p className="mt-16 max-w-2xl text-[11px] text-black/40 dark:text-white/40 leading-relaxed">
           Independent advisory for NCLAT appeals focused on appellate strategy and statutory compliance.

Independent NCLAT advisory supporting informed appellate and regulatory decisions.
          </p>
        </main>
        ...
        <footer className="border-t border-black/10 dark:border-white/10 py-6 px-4 sm:px-12 text-[11px] text-black/40 dark:text-white/40 flex flex-col sm:flex-row justify-between gap-2">
          ...
          <span>IBC & NCLAT Preparedness Advisory</span>
        </footer>
...
const services = [
  {
    ...
    desc: "Assessment of disputes and regulatory exposure prior to appellate action.",
    icon: "bi-search"
  },
  {
    title: "Appeal Readiness Assessment",
    desc: "Evaluation of orders, timelines, and feasibility of NCLAT appeals.",
    icon: "bi-diagram-3"
  },
  {
    title: "IBC Distress Advisory",
    desc: "Advisory for companies and promoters in IBC-related distress situations.",
    icon: "bi-bank"
  },
  {
    title: "Promoter & Management Advisory",
    desc: "Strategic advisory for promoters and management during appellate matters.",
    icon: "bi-person-badge"
  },
  {
    title: "Regulatory Risk Assessment",
    desc: "Identification and assessment of legal and regulatory risks.",
    icon: "bi-file-text"   // ✅ Changed here
  },
  {
    title: "Litigation Coordination Advisory",
    desc: "Advisory support for coordination with legal counsel and appellate processes.",
    icon: "bi-people"
  },
];
