      ...
      <div className="relative min-h-screen flex flex-col pb-28 font-[Inter] transition-colors duration-500 bg-gradient-to-b from-white to-white dark:from-black dark:to-black text-black dark:text-white">
        ...
        <header className="py-8 border-b border-black/10 dark:border-white/10 text-center relative z-10">
          ...
          <p className="text-black/40 dark:text-white/40 text-[11px] sm:text-sm mt-1 tracking-wide">
           NSE Regulatory & Listing Compliance Services
          </p>
        </header>
        ...
        <main className="flex-grow px-4 sm:px-12 lg:px-24 py-14 relative z-10">
          ...
          <section className="max-w-3xl mx-auto text-center lg:text-left">
            <h2 className="font-[Playfair_Display] text-[26px] sm:text-4xl md:text-5xl leading-snug bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
              NSE Filings, Listing Compliances, and Maintenance of Exchange Records
            </h2>

            <p className="mt-4 text-black/65 dark:text-white/65 text-sm sm:text-base leading-relaxed">
              Independent Company Secretary advisory for NSE-related matters, ensuring accurate disclosures, timely exchange filings, and adherence to NSE Listing Regulations. Services include end-to-end NSE filings, regulatory reporting, and continuous listing compliance monitoring.
            </p>
            ...
            <span>Annual NSE Listing Compliances</span>
<span>Event-Based NSE Filings & Disclosures</span>
<span>Statutory Exchange Updates & Compliance Reporting</span>
          ...
          <p className="mt-16 max-w-2xl text-[11px] text-black/40 dark:text-white/40 leading-relaxed">
            Independent Company Secretary advisory focused on NSE filings, listing compliance management, and exchange record maintenance.
          </p>
        </main>
        ...
        <footer className="border-t border-black/10 dark:border-white/10 py-6 px-4 sm:px-12 text-[11px] text-black/40 dark:text-white/40 flex flex-col sm:flex-row justify-between gap-2">
          ...
          <span> NSE Regulatory & Listing Compliance Services</span>
        </footer>
...
const services = [
  {
    title: "Annual NSE Listing Compliances",
    desc: "Preparation and submission of annual disclosures and compliance reports as per NSE Listing Regulations.",
    icon: "bi-calendar-check"
  },
  {
    title: "Event-Based NSE Filings & Disclosures",
    desc: "Timely exchange filings for board outcomes, corporate actions, disclosures, and material events.",
    icon: "bi-arrow-repeat"
  },
  {
    title: "Corporate Governance Compliance",
    desc: "Compliance support for corporate governance requirements including committee disclosures and reports.",
    icon: "bi-diagram-3"
  },
  {
    title: "Maintenance of NSE Exchange Records",
    desc: "Systematic maintenance of exchange-related records, disclosures, and compliance documentation.",
    icon: "bi-journal-text"
  },
  {
    title: "Listing Compliance Monitoring",
    desc: "Continuous monitoring of NSE compliance timelines to ensure timely filings and avoid non-compliance.",
    icon: "bi-shield-check"
  },
  {
    title: "Board & Disclosure Documentation Support",
    desc: "Assistance with board outcome filings, disclosures, and documentation required under NSE regulations.",
