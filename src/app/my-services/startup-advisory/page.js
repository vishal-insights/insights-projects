        ...
        <main className="flex-grow px-4 sm:px-12 lg:px-24 py-14 relative z-10">
          ...
          <section className="max-w-3xl mx-auto text-center lg:text-left">
            <h2 className="font-[Playfair_Display] text-[26px] sm:text-4xl md:text-5xl leading-snug bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
              Strategic Advisory for Startups & Founders
            </h2>

            <p className="mt-4 text-black/65 dark:text-white/65 text-sm sm:text-base leading-relaxed">
              Independent startup advisory focused on strategy, growth planning
              and founder-level decision making.
            </p>
...
const services = [
  { title: "Startup Strategy Advisory", desc: "Business model validation and positioning.", icon: "bi-lightbulb" },
  { title: "Early-Stage Advisory", desc: "Guidance for idea and early-stage startups.", icon: "bi-rocket-takeoff" },
  { title: "Growth Planning", desc: "Structured planning for scale.", icon: "bi-graph-up-arrow" },
  { title: "Founder Advisory", desc: "One-on-one decision advisory.", icon: "bi-person-workspace" },
  { title: "Investment Readiness", desc: "Investor conversation preparation.", icon: "bi-cash-stack" },
  { title: "Business Risk Advisory", desc: "Identifying strategic risks.", icon: "bi-shield-exclamation" },
];
