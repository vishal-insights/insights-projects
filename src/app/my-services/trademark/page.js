      ...
      <div className="relative min-h-screen flex flex-col pb-28 font-[Inter] transition-colors duration-500 bg-gradient-to-b from-white to-white dark:from-black dark:to-black text-black dark:text-white">
        ...
        <header className="py-8 border-b border-black/10 dark:border-white/10 text-center relative z-10">
          ...
          <p className="text-black/40 dark:text-white/40 text-[11px] sm:text-sm mt-1 tracking-wide">
            Trademark Filing & Registration Services
          </p>
        </header>
        ...
        <main className="flex-grow px-4 sm:px-12 lg:px-24 py-14 relative z-10">
          ...
          <section className="max-w-3xl mx-auto text-center lg:text-left">
            <h2 className="font-[Playfair_Display] text-[26px] sm:text-4xl md:text-5xl leading-snug bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
              Secretary support for trademark filing, registration, and statutory compliance.
            </h2>

            <p className="mt-4 text-black/65 dark:text-white/65 text-sm sm:text-base leading-relaxed">
              Dedicated Company Secretary advisory ensuring smooth trademark filing, registration, and maintenance under the Trade Marks Act.
            </p>
            ...
            <div className="mt-6 flex flex-wrap justify-center lg:justify-start gap-x-4 gap-y-2 text-[12px] sm:text-sm text-black/50 dark:text-white/50">
              <span>Trademark Search & Availability Advisory</span>
<span>Trademark Application Filing & Registration</span>
<span>Trademark Renewal, Assignment & Recordal</span>
          ...
          <p className="mt-16 max-w-2xl text-[11px] text-black/40 dark:text-white/40 leading-relaxed">
            Independent Company Secretary support ensuring compliant trademark filing, registration, and statutory compliance.
          </p>
        </main>
        ...
        <footer className="border-t border-black/10 dark:border-white/10 py-6 px-4 sm:px-12 text-[11px] text-black/40 dark:text-white/40 flex flex-col sm:flex-row justify-between gap-2">
          ...
          <span>Trademark Filing & Registration Services</span>
        </footer>
...
const services = [
  {
    ...
    desc: "Preliminary search and advisory to ensure trademark availability and uniqueness before filing.",
    icon: "bi-search"
  },
  {
    title: "Trademark Application Filing",
    desc: "Preparation and filing of trademark applications under relevant classes with the Trademark Registry.",
    icon: "bi-file-earmark-plus"
  },
  {
    title: "Examination & Objection Response",
    desc: "Assistance in responding to examination reports, objections, or queries from the Trademark Registry.",
    icon: "bi-pencil-square"
  },
  {
    title: "Trademark Renewal & Maintenance",
    desc: "Filing and advisory for renewal of trademarks, ensuring compliance with statutory timelines.",
    icon: "bi-arrow-repeat"
  },
  {
    title: "Trademark Assignment & Recordal",
    desc: "Support in assignment, transfer, or recordal of trademarks in statutory registers.",
    icon: "bi-journal-text"
  },
  {
    title: "Compliance & Documentation Support",
    desc: "Guidance on proper documentation and statutory compliance throughout the trademark lifecycle.",
