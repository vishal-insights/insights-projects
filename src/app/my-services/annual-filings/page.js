      ...
      <div className="relative min-h-screen flex flex-col pb-28 font-[Inter] transition-colors duration-500 bg-gradient-to-b from-white to-white dark:from-black dark:to-black text-black dark:text-white">
        ...
        <header className="py-8 border-b border-black/10 dark:border-white/10 text-center relative z-10">
          ...
          <p className="text-black/40 dark:text-white/40 text-[11px] sm:text-sm mt-1 tracking-wide">
            Annual Filing & ROC Compliance Services
          </p>
        </header>
        ...
        <main className="flex-grow px-4 sm:px-12 lg:px-24 py-14 relative z-10">
          ...
          <section className="max-w-3xl mx-auto text-center lg:text-left">
            ...
            <p className="mt-4 text-black/65 dark:text-white/65 text-sm sm:text-base leading-relaxed">
             End-to-end support for annual filings and ROC compliances, ensuring timely submissions and regulatory accuracy.
            </p>
            ...
            <div className="mt-6 flex flex-wrap justify-center lg:justify-start gap-x-4 gap-y-2 text-[12px] sm:text-sm text-black/50 dark:text-white/50">
              <span>Annual ROC Filings (AOC-4, MGT-7 / 7A)</span>
              <span>Director KYC, DIN & MCA Compliance Support</span>
              <span>Compliance Monitoring & Penalty Avoidance</span>
              <span>Annual ROC Filing Advisory</span>
            </div>
          </section>
          ...
          <p className="mt-16 max-w-2xl text-[11px] text-black/40 dark:text-white/40 leading-relaxed">
           Independent Company Secretary advisory focused on annual filings, ROC compliances, and statutory adherence under the Companies Act.
          </p>
        </main>
        ...
        <footer className="border-t border-black/10 dark:border-white/10 py-6 px-4 sm:px-12 text-[11px] text-black/40 dark:text-white/40 flex flex-col sm:flex-row justify-between gap-2">
          ...
          <span>Annual Filing & ROC Compliance Services</span>
        </footer>
...
const services = [
  {
    ...
    desc: "Preparation and filing of AOC-4, MGT-7 / MGT-7A as per Companies Act timelines.",
    icon: "bi-calendar-check"
  },
  {
    title: "Director KYC & DIN Compliance",
    desc: "DIR-3 KYC filing and DIN-related compliance for directors.",
    icon: "bi-person-vcard"
  },
  {
    title: "Statutory Registers Maintenance",
    desc: "Maintenance and updating of statutory registers and corporate records.",
    icon: "bi-journal-text"
  },
  {
    title: "Board Report & Disclosure Support",
    desc: "Drafting of Board’s Report and statutory disclosures for annual filings.",
    icon: "bi-file-earmark-text"
  },
  {
    title: "Event-Based ROC Filings",
    desc: "ROC filings for changes in directors, auditors, capital, or registered office.",
    icon: "bi-arrow-repeat"
  },
  {
    title: "Compliance Monitoring & Penalty Avoidance",
    desc: "Compliance calendar management, due-date tracking, and penalty prevention.",
