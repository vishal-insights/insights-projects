...
export default function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>S K Dwivedi & Associates</title>
        <meta
          name="description"
      ...
      <div className="relative min-h-screen flex flex-col pb-28 font-[Inter] transition-colors duration-500 bg-gradient-to-b from-white to-white dark:from-black dark:to-black text-black dark:text-white">
        ...
        <header className="py-8 border-b border-black/10 dark:border-white/10 text-center relative z-10">
          ...
          <p className="text-black/40 dark:text-white/40 text-[11px] sm:text-sm mt-1 tracking-wide">
            GST & Regulatory Compliance Services
          </p>
        </header>
        ...
        <main className="flex-grow px-4 sm:px-12 lg:px-24 py-14 relative z-10">
          ...
          <section className="max-w-3xl mx-auto text-center lg:text-left">
            <h2 className="font-[Playfair_Display] text-[26px] sm:text-4xl md:text-5xl leading-snug bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
              Support for GST filings, regulatory compliance, and statutory adherence.
            </h2>

            <p className="mt-4 text-black/65 dark:text-white/65 text-sm sm:text-base leading-relaxed">
              Dedicated Company Secretary advisory ensuring smooth GST filings, regulatory compliance, and statutory adherence.
            </p>
            ...
            <div className="mt-6 flex flex-wrap justify-center lg:justify-start gap-x-4 gap-y-2 text-[12px] sm:text-sm text-black/50 dark:text-white/50">
             <span>GST Registration & Advisory</span>
<span>GST Returns Filing & Reconciliation</span>
<span>Regulatory Compliance & Reporting</span>
          ...
          <p className="mt-16 max-w-2xl text-[11px] text-black/40 dark:text-white/40 leading-relaxed">
            Independent Company Secretary support ensuring compliant GST filings, regulatory compliance, and statutory adherence.
          </p>
        </main>
        ...
        <footer className="border-t border-black/10 dark:border-white/10 py-6 px-4 sm:px-12 text-[11px] text-black/40 dark:text-white/40 flex flex-col sm:flex-row justify-between gap-2">
          ...
          <span>GST & Regulatory Compliance Services</span>
        </footer>
...
const services = [
  {
    title: "GST Registration & Advisory",
    desc: "Assistance with new GST registration, amendments, and advisory on GST applicability and compliance.",
    icon: "bi-clipboard-check"
  },
  {
    title: "GST Returns Filing",
    desc: "Preparation and filing of GSTR-1, GSTR-3B, GSTR-9 and other relevant GST returns within statutory timelines.",
    icon: "bi-file-earmark-plus"
  },
  {
    title: "Input Tax Credit & Reconciliation",
    desc: "Guidance on claiming ITC, reconciliation of GST ledgers, and compliance checks for accurate reporting.",
    icon: "bi-arrow-repeat"
  },
  {
    title: "GST Audit & Annual Compliance",
    desc: "Advisory for GST audit, annual returns, and related statutory documentation and reporting.",
    icon: "bi-journal-text"
  },
  {
    title: "Regulatory Filings & Reporting",
    desc: "Support in filings required under Companies Act, ROC, and other regulatory authorities related to GST compliance.",
    icon: "bi-graph-up"
  },
  {
    title: "Compliance Monitoring & Penalty Avoidance",
    desc: "Proactive monitoring, reminders, and rectification to avoid GST penalties and ensure timely compliance.",
