      ...
      <div className="relative min-h-screen flex flex-col pb-28 font-[Inter] transition-colors duration-500 bg-gradient-to-b from-white to-white dark:from-black dark:to-black text-black dark:text-white">
        ...
        <header className="py-8 border-b border-black/10 dark:border-white/10 text-center relative z-10">
          ...
          <p className="text-black/40 dark:text-white/40 text-[11px] sm:text-sm mt-1 tracking-wide">
            Corporate Law & Statutory Compliance Services
          </p>
        </header>
        ...
        <main className="flex-grow px-4 sm:px-12 lg:px-24 py-14 relative z-10">
          ...
          <section className="max-w-3xl mx-auto text-center lg:text-left">
            <h2 className="font-[Playfair_Display] text-[26px] sm:text-4xl md:text-5xl leading-snug bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
              Statutory Filings, Corporate Compliance, and Regulatory Representation
            </h2>

            <p className="mt-4 text-black/65 dark:text-white/65 text-sm sm:text-base leading-relaxed">
              Independent Company Secretary advisory for corporate law and statutory matters, ensuring accurate documentation, timely regulatory filings, and adherence to Companies Act provisions. Services include end-to-end statutory filings, regulatory representation, and continuous compliance monitoring before authorities.
            </p>
            ...
            <div className="mt-6 flex flex-wrap justify-center lg:justify-start gap-x-4 gap-y-2 text-[12px] sm:text-sm text-black/50 dark:text-white/50">
             <span>Annual Statutory Filings & Compliance</span>
<span>Event-Based Corporate Filings & Documentation</span>
<span>Regulatory Representation & Compliance Monitoring</span>
          ...
          <p className="mt-16 max-w-2xl text-[11px] text-black/40 dark:text-white/40 leading-relaxed">
            Independent Company Secretary advisory focused on statutory filings, corporate compliance management, and regulatory representation.
          </p>
        </main>
        ...
        <footer className="border-t border-black/10 dark:border-white/10 py-6 px-4 sm:px-12 text-[11px] text-black/40 dark:text-white/40 flex flex-col sm:flex-row justify-between gap-2">
          ...
          <span> Corporate Law & Statutory Compliance Services</span>
        </footer>
...
const services = [
  {
    title: "Regulatory Applications & Approvals Support",
    desc: "Company Secretary support for preparation, documentation, and coordination of regulatory and tribunal-related applications.",
    icon: "bi-file-earmark-check"
  },
  {
    title: "Scheme & Corporate Action Documentation",
    desc: "Compliance assistance for schemes, restructuring documentation, and statutory filings linked to regulatory approvals.",
    icon: "bi-diagram-3"
  },
  {
    title: "Tribunal-Linked Compliance Filings",
    desc: "Preparation and filing of statutory forms, disclosures, and compliance documents arising from regulatory or tribunal processes.",
    icon: "bi-upload"
  },
  {
    title: "Stakeholder & Authority Coordination",
    desc: "Professional coordination with regulators, exchanges, and stakeholders for compliance-related submissions and approvals.",
    icon: "bi-people"
  },
  {
    title: "Post-Approval Compliance Management",
    desc: "Ensuring timely follow-up filings, disclosures, and compliance actions after regulatory or tribunal approvals.",
    icon: "bi-shield-check"
  },
  {
    title: "Compliance Documentation & Record Maintenance",
    desc: "Maintenance of statutory and regulatory records connected with approval-based and special corporate matters.",
