        ...
        <main className="flex-grow px-4 sm:px-12 lg:px-24 py-14 relative z-10">
          ...
          <section className="max-w-3xl mx-auto text-center lg:text-left">
            <h2 className="font-[Playfair_Display] text-[26px] sm:text-4xl md:text-5xl leading-snug bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
              RBI Approvals, Filings & Regulatory Advisory
            </h2>

            <p className="mt-4 text-black/65 dark:text-white/65 text-sm sm:text-base leading-relaxed">
              Independent RBI approvals and filings advisory supporting regulatory compliance and statutory decision-making.
            </p>
            ...
            <div className="mt-6 flex flex-wrap justify-center lg:justify-start gap-x-4 gap-y-2 text-[12px] sm:text-sm text-black/50 dark:text-white/50">
              <span>RBI Approvals & Filings</span>
              <span>RBI Regulatory Approvals</span>
              <span>RBI Filings</span>
            </div>
          </section>
          ...
          <p className="mt-16 max-w-2xl text-[11px] text-black/40 dark:text-white/40 leading-relaxed">
            RBI approval and filing services are advisory and facilitative in nature. Approvals are subject to regulatory authority discretion. All discussions and information are kept confidential.
          </p>
        </main>
...
const services = [
  {
    title: "RBI Approval Advisory",
    desc: "Advisory and assistance for approvals from the Reserve Bank of India.",
    icon: "bi-bank"
  },
  {
    title: "FEMA Compliance & Filings",
    desc: "End-to-end FEMA compliance, reporting, and regulatory filings.",
    icon: "bi-globe"
  },
  {
    title: "FDI / ODI Filings",
    desc: "Preparation and filing of FDI and ODI related returns with RBI.",
    icon: "bi-arrow-left-right"
  },
  {
    title: "Annual Return on Foreign Liabilities & Assets (FLA)",
    desc: "Timely preparation and filing of FLA returns with RBI.",
    icon: "bi-calendar-check"
  },
  {
    title: "ECB Compliance & Reporting",
    desc: "Advisory on External Commercial Borrowings and related RBI filings.",
    icon: "bi-currency-exchange"
  },
  {
    title: "Compounding of Offences",
    desc: "Support for RBI compounding applications and regulatory resolution.",
