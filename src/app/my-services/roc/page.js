      ...
      <div className="relative min-h-screen flex flex-col pb-28 font-[Inter] transition-colors duration-500 bg-gradient-to-b from-white to-white dark:from-black dark:to-black text-black dark:text-white">
        ...
        <header className="py-8 border-b border-black/10 dark:border-white/10 text-center relative z-10">
          ...
          <p className="text-black/40 dark:text-white/40 text-[11px] sm:text-sm mt-1 tracking-wide">
            ROC Matters & Compliance Services
          </p>
        </header>
        ...
        <main className="flex-grow px-4 sm:px-12 lg:px-24 py-14 relative z-10">
          ...
          <section className="max-w-3xl mx-auto text-center lg:text-left">
            <h2 className="font-[Playfair_Display] text-[26px] sm:text-4xl md:text-5xl leading-snug bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
              ROC filings, statutory compliance, and corporate record maintenance.
            </h2>

            <p className="mt-4 text-black/65 dark:text-white/65 text-sm sm:text-base leading-relaxed">
              Independent Company Secretary advisory for ROC-related matters, ensuring accurate documentation, timely statutory filings, and adherence to the Companies Act, 2013. Services cover all ROC filings, regulatory reporting, and compliance monitoring.
            </p>
            ...
            <div className="mt-6 flex flex-wrap justify-center lg:justify-start gap-x-4 gap-y-2 text-[12px] sm:text-sm text-black/50 dark:text-white/50">
             <span>Annual ROC Filings & Compliance</span>
<span>Event-Based ROC Filings</span>
<span>Director KYC & Statutory Updates</span>
          ...
          <p className="mt-16 max-w-2xl text-[11px] text-black/40 dark:text-white/40 leading-relaxed">
            Independent Company Secretary advisory focused on ROC filings, statutory compliance, and corporate record management.
          </p>
        </main>
        ...
        <footer className="border-t border-black/10 dark:border-white/10 py-6 px-4 sm:px-12 text-[11px] text-black/40 dark:text-white/40 flex flex-col sm:flex-row justify-between gap-2">
          ...
          <span> ROC Matters & Compliance Services</span>
        </footer>
...
const services = [
  {
    ...
    desc: "Preparation and filing of AOC-4, MGT-7 / 7A and other annual statutory forms as per Companies Act.",
    icon: "bi-calendar-check"
  },
  {
    title: "Event-Based ROC Filings",
    desc: "ROC filings for changes in directors, auditors, shareholding, capital, or registered office.",
    icon: "bi-arrow-repeat"
  },
  {
    title: "Director KYC & DIN Compliance",
    desc: "DIR-3 KYC filings and other statutory updates for directors and key managerial personnel.",
    icon: "bi-person-vcard"
  },
  {
    title: "Maintenance of Statutory Registers",
    desc: "Updating and maintaining statutory registers and corporate records as required by law.",
    icon: "bi-journal-text"
  },
  {
    title: "Compliance Monitoring & Penalty Avoidance",
    desc: "Tracking ROC filing deadlines, ensuring timely submissions, and preventing penalties.",
    icon: "bi-shield-check"
  },
  {
    title: "Corporate Documentation Support",
    desc: "Assistance with board resolutions, minutes, and all statutory documentation for ROC matters.",
