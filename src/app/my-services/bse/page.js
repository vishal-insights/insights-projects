        ...
        <main className="flex-grow px-4 sm:px-12 lg:px-24 py-14 relative z-10">
          ...
          <section className="max-w-3xl mx-auto text-center lg:text-left">
            <h2 className="font-[Playfair_Display] text-[26px] sm:text-4xl md:text-5xl leading-snug bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
              BSE Compliance Advisory for Growing & Listed Companies
            </h2>

            <p className="mt-4 text-black/65 dark:text-white/65 text-sm sm:text-base leading-relaxed">
              Independent BSE compliance advisory supporting board-level governance and statutory decision-making.
            </p>
            ...
            <div className="mt-6 flex flex-wrap justify-center lg:justify-start gap-x-4 gap-y-2 text-[12px] sm:text-sm text-black/50 dark:text-white/50">
              <span>BSE Compliance Advisory</span>
          ...
          <p className="mt-16 max-w-2xl text-[11px] text-black/40 dark:text-white/40 leading-relaxed">
            Advisory services are strategic and consultative in nature.
            Outcomes are not guaranteed. All discussions are confidential.
          </p>
        </main>
...
const services = [
  {
    title: "BSE Compliance Advisory",
    desc: "End-to-end compliance support for BSE-listed companies.",
    icon: "bi-journal-check"
  },
  {
    title: "SEBI & LODR Compliance",
    desc: "Advisory on SEBI regulations and LODR requirements.",
    icon: "bi-shield-check"
  },
  {
    title: "Board & Governance Advisory",
    desc: "Support for board processes, governance frameworks, and resolutions.",
    icon: "bi-people"
  },
  {
    title: "Statutory Filings & Disclosures",
    desc: "Timely filings, disclosures, and regulatory reporting with BSE.",
    icon: "bi-file-earmark-text"
  },
  {
    title: "Corporate Action Compliance",
    desc: "Compliance advisory for dividends, bonus issues, and rights issues.",
    icon: "bi-diagram-3"
  },
  {
    title: "Secretarial Audit & Due Diligence",
    desc: "Compliance review, secretarial audit, and regulatory due diligence.",
    icon: "bi-search"
  },
];
